    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers("/publicar/**", "/editar-publicacion/**", "/borrar-publicacion/**", "/publicaciones","/nuevoProveedor","/editarEstado/**", "/eliminarImagen/**", "/actualizar/**", "/cambiar-estado/**").hasRole("ADMIN") // Solo ADMIN puede publicar, editar y borrar publicaciones
